...
function main()
    ...
    cam = Camera(
        ...
        samples_per_pixel=100,
        max_depth=50,
        vfov=20.0,  # Narrower field of view for a zoomed-in effect
        ...
        defocus_angle=10.0,            # Defocus blur angle
        focus_dist=3.4                 # Focus distance
    )

    # Render the scene
    render(cam, world, "images/ch13_image.ppm")
    ppm_to_jpg("images/ch13_image.ppm", "images/ch13_image.jpg")
end
